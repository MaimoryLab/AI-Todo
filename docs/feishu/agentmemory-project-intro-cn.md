...
![Agent Memory Lab 产品工作流](whiteboards/workflow.png)
...
![仓库结构与交付边界](whiteboards/structure.png)
...
公司仓库 `novitalabs/agentmemory-lab` 的目标分支受保护，不能直接推送，改动需要通过 PR 合并。当前最新交付 PR：<https://github.com/novitalabs/agentmemory-lab/pull/3>。
...
| GitHub | 公司仓库目标分支受保护；最新改动已进入 PR：<https://github.com/novitalabs/agentmemory-lab/pull/3> |
